...
public void exam_que() {
	...
	while(System.currentTimeMillis()<endtime) {
		...
		System.out.println("\n\nQ.1) Which is the capital of India?");
		System.out.println("\n(1) Mumbai"+"\t"+"(2) Delhi"+"\t"+"(3) Pune"+"\t"+"(4) Rajastan");
		...
		System.out.println("\n\nQ.2) Which team has won the FIFA World Cup 2022 ?");
		System.out.println("1)Brazil"+"\t"+"2)Argentina"+"\t"+"3) England"+"\t"+"4)Germany");
		System.out.println("Enter correct option");
		ans=sc.nextInt();
		System.out.println("Answer Locked...");
		if(ans==2) {
		...
		System.out.println("\n\nQ.5) Who is current President of India ?");
		System.out.println("1) Droupadi Murmu"+"\t"+"2) Ramanath kovind"+"\t"+"3) Rajendra Prasad "+"\t"+"4) Zakir Husain");
		System.out.println("Enter correct option");
		ans=sc.nextInt();
		System.out.println("Answer Locked...");
		if(ans==1) {
